...
- 低風險、可逆的下一步直接做，不要把一般性確認丟回使用者
- 每次改完都要有證據：測試、實跑、或輸出檔案檢查
- 每一輪盡量收成可回退節點，讓 git 歷史能反映決策
- 主線優先順序是：
  - 本機工作台可用性
  - 可煮飯方便程度搜尋
  - 松仁路 100 號案例工作區
...
```text
延續目前狀態，不要重新探索。
少問我，自己規劃、自己驗證、自己 commit。
主軸是可煮飯方便程度搜尋工作台。
先讀 README.md 與 PROGRESS.md。
主要案例工作區是 data/cases/songren_100。
```
